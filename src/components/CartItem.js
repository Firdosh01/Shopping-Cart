        ...
        <div className='flex justify-between py-3.5 px-2.5 gap-14 flex-col md:flex-row'>
            ...
            <div className='md:w-[70%] w-full flex flex-col gap-5'>
                ...
                <div className='flex justify-between'>
                    ...
                    <div onClick={removeFromCart} className='flex items-center justify-center w-10 h-10 transition-all bg-red-200 rounded-full cursor-pointer hover:bg-red-400 group'>
